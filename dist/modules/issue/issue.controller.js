...
let IssueController = class IssueController {
    ...
    mappedDoctors(id) { return this.svc.getMappedDoctors(id); }
};
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], IssueController.prototype, "list", null);
__decorate([
    (0, common_1.Get)(':id/mapped-doctors'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], IssueController.prototype, "mappedDoctors", null);
