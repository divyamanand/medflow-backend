...
export declare class StaffService {
    ...
    getSpecialties(staffId: string): Promise<any>;
    addSpecialty(staffId: string, specialtyId: string, primary?: boolean): Promise<any>;
    removeSpecialty(staffId: string, specialtyId: string): Promise<{
        id: string;
        removed: boolean;
    }>;
